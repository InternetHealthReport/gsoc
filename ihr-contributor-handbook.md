...
- **Technical Writers** are welcome to document any of the events and insights found in IHR data.

## 4.2. Prerequisites

A basic computer networking background is needed to understand IHR tools and make relevant contributions. If you want to dive into the IHR code base, we are mostly using JavaScript (Vue.js) for the frontend and Python for the backend. 
